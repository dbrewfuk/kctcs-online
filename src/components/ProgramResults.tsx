...
const ProgramResults = ({ filteredAcademicPlans, showLimit, filters }) => {
  ...
  return (
    <div className="w-full">
      <div className="h-full">
        <div className="container border border-b-[0] border-[#00467F] flex flex-col mx-auto">
          {filters && (
          ...
          {/* Results section */}
          <span className="text-semibold text-[#00467F] px-[32px] py-[16px] border-b">
          ...
          <div className="grid grid-cols-1 group">
            {filteredAcademicPlans
              ...
              .map((plan, index) => (
                <div
                  key={index}
                  className={`group-hover:opacity-70 hover:opacity-100 transition-opacity ease-in-out duration-[250ms] ${expandedPrograms[index] ? "" : ""}`}
                >
                  {/* Render each unique academic plan */}
                  <div className="px-[24px] lg:px-[32px] transition-all ease duration-[200ms] border-b border-[#00467F] cursor-pointer">
                    <div className="flex flex-col h-full justify-between relative">
                      ...
                      >
                        <div className="flex py-[24px] flex-col items-start md:flex-row gap-[8px]">
                          <h3 className="text-[32px] leading-[36px] text-[#00467F] font-semibold">
                            <span>{plan.name}</span>
                            <span className="align-super ml-[12px] py-[4px] border-b border-[#00467F] inline font-semibold text-[#00467F] text-[14px]">
                        ...
                        <div
                          className={`absolute right-[24px] top-[24px] transform transition-transform ease-in-out duration-250 ${expandedPrograms[index] ? "rotate-45" : "rotate-0"}`}
                        >
                          <svg
                            width="33"
                            height="34"
                      ...
                      {expandedPrograms[index] && (
                        <div className="flex flex-col pb-[48px]">
                          <div className="w-full">
                            <div className="text-[#00467F] text-[24px] font-[800] mb-[16px]">
                          ...
                          <div className="w-full">
                            ...
                            <div
                              className={`${selectedColleges[index]?.name ? "block" : "hidden"}`}
                            >
                              ...
                              <div className="flex flex-col items-center py-[8px]">
                                <button
                                  type="button"
                                  className="px-[24px] rounded-full border py-[12px] whitespace-nowrap text-ellipsis overflow-hidden cursor-pointer font-semibold bg-[#00467F] text-white text-[18px] hover:bg-[white] hover:text-[#00467F] transition ease-in-out duration-250 hover:border-[#00467F] text-center"
                                >
                                  Request Information
                                </button>
                              </div>
