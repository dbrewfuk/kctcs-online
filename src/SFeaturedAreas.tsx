...
function SFeaturedAreas() {
  ...
  return (
    <>
      <div className="lg:pt-[128px] lg:pb-[96px]">
        <div className="flex flex-col">
          ...
          <div className="flex flex-col lg:flex-row gap-[32px] lg:gap-[64px] mb-[48px] lg:mb-[0] items-center lg:container lg:mx-auto lg:px-0">
            <div className="w-full lg:w-[50%] h-full relative z-1 aspect-[16/9] overflow-hidden lg:rounded-br-[12px]">
              <img
            ...
            <div className="px-[24px] lg:px-0 max-w-[596px]">
              ...
              <div className="w-full text-center mt-[32px] lg:mt-[48px]">
                <Button
      ...
      <div className="relative w-full container mx-auto px-[24px] lg:px-0 mx-auto pb-[64px] pt-[32px] lg:pt-[56px] border-t-[1px] border-[#f0f0f0] lg:pb-[96px]">
        <h3 className="text-[31px] leading-[36px] lg:text-[39px] leading-[44px] mb-[56px] font-[800] text-[#00467F]">
          Shape Your Future: Programs for Today's Workforce
        </h3>
